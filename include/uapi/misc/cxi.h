...
#define CXI_RGROUP_NAME_LEN    64

struct cxi_dev_alloc_rgroup_cmd {
...
struct cxi_dev_alloc_rgroup_resp {
	unsigned int           rgroup_id;
};

struct cxi_dev_get_rgroup_ids_cmd {
	struct cxi_common_cmd  common;
	size_t                 max_ids;
	unsigned int           *rgroup_ids;
};

struct cxi_dev_get_rgroup_ids_resp {
	size_t                 num_ids;
};

struct cxi_rgroup_release_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rgroup_id;
};

struct cxi_rgroup_enable_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rgroup_id;
};

struct cxi_rgroup_disable_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rgroup_id;
};

struct cxi_rgroup_get_info_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rgroup_id;
};

struct cxi_rgroup_get_info_resp {
	struct {
		unsigned int   cntr_pool_id;
		bool           system_service;
		char           name[CXI_RGROUP_NAME_LEN];
...
struct cxi_rgroup_add_resource_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rgroup_id;
...
struct cxi_rgroup_delete_resource_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	unsigned int            resource_type;
};

struct cxi_rgroup_get_resource_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	unsigned int            resource_type;
};

struct cxi_rgroup_get_resource_resp {
	struct {
		size_t          reserved;
		size_t          max;
	} limits;
...
struct cxi_rgroup_get_resource_types_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	size_t                  max_types;
...
struct cxi_rgroup_get_resource_types_resp {
	size_t                  num_types;
};
...
struct cxi_rgroup_add_ac_entry_resp {
	unsigned int            ac_entry_id;
};

struct cxi_rgroup_delete_ac_entry_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	unsigned int            ac_entry_id;
};

struct cxi_rgroup_get_ac_entry_ids_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	size_t                  max_ids;
	unsigned int            *ids;
...
struct cxi_rgroup_get_ac_entry_ids_resp {
	size_t                  num_ids;
};

struct cxi_rgroup_get_ac_entry_data_by_id_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	unsigned int            ac_entry_id;
};

struct cxi_rgroup_get_ac_entry_data_by_id_resp {
	unsigned int            ac_type;
	uid_t                   uid;
	gid_t                   gid;
};

struct cxi_rgroup_get_ac_entry_id_by_data_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	unsigned int            ac_type;
	uid_t                   uid;
...
struct cxi_rgroup_get_ac_entry_id_by_data_resp {
	unsigned int            ac_entry_id;
};

struct cxi_rgroup_get_ac_entry_id_by_user_cmd {
	struct cxi_common_cmd   common;
	unsigned int            rgroup_id;
	uid_t                   uid;
	gid_t                   gid;
...
struct cxi_rgroup_get_ac_entry_id_by_user_resp {
	unsigned int            ac_entry_id;
};
...
struct cxi_dev_alloc_rx_profile_resp {
	unsigned int    id;
};

struct cxi_dev_get_rx_profile_ids_cmd {
	struct cxi_common_cmd   common;
	size_t                  max_ids;
	unsigned int            *ids;
};

struct cxi_dev_get_rx_profile_ids_resp {
	size_t                  num_ids;
};

struct cxi_rx_profile_get_info_cmd {
	struct cxi_common_cmd   common;
	unsigned int            id;
};

struct cxi_rx_profile_get_info_resp {
	struct {
		uint16_t   match;
		uint16_t   ignore;
		char       name[CXI_VNI_NAME_LEN];
...
struct cxi_rx_profile_release_cmd {
	struct cxi_common_cmd   common;
	unsigned int            id;
};

struct cxi_rx_profile_revoke_cmd {
	struct cxi_common_cmd   common;
	unsigned int            id;
};

struct cxi_rx_profile_add_ac_entry_cmd {
	struct cxi_common_cmd  common;
...
struct cxi_rx_profile_add_ac_entry_resp {
	unsigned int           ac_entry_id;
};

struct cxi_rx_profile_remove_ac_entry_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rx_profile_id;
	unsigned int           ac_entry_id;
};

struct cxi_rx_profile_get_ac_entry_ids_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rx_profile_id;
	size_t                 max_ids;
...
struct cxi_rx_profile_get_ac_entry_ids_resp {
	size_t                 num_ids;
};

struct cxi_rx_profile_get_ac_entry_data_by_id_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rx_profile_id;
	unsigned int           ac_entry_id;
};

struct cxi_rx_profile_get_ac_entry_data_by_id_resp {
	int                    type;
	uid_t                  uid;
	gid_t                  gid;
};

struct cxi_rx_profile_get_ac_entry_id_by_data_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rx_profile_id;
	int                    type;
	uid_t                  uid;
...
struct cxi_rx_profile_get_ac_entry_id_by_data_resp {
	unsigned int           ac_entry_id;
};

struct cxi_rx_profile_get_ac_entry_id_by_user_cmd {
	struct cxi_common_cmd  common;
	unsigned int           rx_profile_id;
	unsigned int           desired_types;
	uid_t                  uid;
